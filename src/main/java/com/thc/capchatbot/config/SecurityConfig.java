...
import com.thc.capchatbot.security.*;
...
public class SecurityConfig {
    ...
    public SecurityConfig(UserRepository userRepository, CorsFilterConfiguration corsFilterConfiguration, ObjectMapper objectMapper, AuthService authService, ExternalProperties externalProperties) {
